...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout7 <?php if($settings['style_l7'] == 'style1') { echo 'dot-style-u1'; } else { echo 'dot-style-u2'; } ?> ct-slick-slider <?php echo esc_attr($settings['style_l7']); ?>">
